...
export function ServiceCard({ icon, title, description, features, onClick, delay = 0 }: ServiceCardProps) {
  ...
  return (
    ...
    >
      <div className="relative h-full bg-[#121212] rounded-lg border border-[#262626] p-6 transition-all duration-200 hover:border-[#f59e0b]/50 cursor-pointer overflow-hidden" onClick={onClick}>
