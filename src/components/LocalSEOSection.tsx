      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Your Trusted <span className="text-[#f59e0b]">Local Partner</span>{" "}
            in Patna
          </h2>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Helping businesses across Patna and Bihar succeed with reliable
            websites, custom apps, and expert advice since 2012.
          </p>
        </motion.div>
        ...
        <div className="mt-12 prose prose-invert max-w-none">
          <div className="bg-[#121212] border border-[#262626] rounded-lg p-8">
            ...
            <div className="text-sm text-gray-400 leading-relaxed space-y-3">
              ...
              <p>
                Our team of certified developers, designers, and consultants
                work with organizations in Phulwari Sharif, Danapur, Kankarbagh,
                and other major areas of Patna to transform their digital
                infrastructure and drive business growth through technology
                innovation.
              </p>
              <p>
                Whether you need custom software development, cloud migration,
                digital transformation consulting, or ongoing IT support, EDUNEX
                provides tailored solutions that align with your business
