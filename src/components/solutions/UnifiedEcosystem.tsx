  ...
  return (
    <section className="py-24 bg-[#050505] overflow-hidden relative">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="bg-gradient-to-br from-[#121212] via-[#0a0a0a] to-black border border-white/10 rounded-3xl md:rounded-[3rem] p-8 md:p-12 lg:p-20 relative shadow-[0_0_80px_rgba(0,0,0,0.8)]">
          {/* Static Soft Background Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] aspect-square bg-[#f59e0b]/5 blur-[120px] rounded-full -z-10" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
            ...
            <div className="relative aspect-square max-w-md mx-auto w-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                      <motion.div
                        ...
                        className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-black/60 backdrop-blur-xl border border-[#f59e0b]/50 flex flex-col items-center justify-center gap-0.5 md:gap-1 shadow-[0_0_20px_rgba(245,158,11,0.2)] pointer-events-auto hover:border-[#f59e0b] hover:bg-[#1a1a1a] transition-all duration-300"
                      >
                        <node.icon className="w-4 h-4 md:w-6 md:h-6 text-[#f59e0b]" />
                        <span className="text-[7px] md:text-[9px] font-bold text-gray-300 uppercase leading-none mt-0.5 md:mt-0">
                          {node.label}
                        </span>
                      </motion.div>
                    </div>
                ...
                {/* Decorative Rings */}
                <div className="absolute inset-[28%] border-2 border-dashed border-[#f59e0b]/40 rounded-full pointer-events-none opacity-80 shadow-[inset_0_0_20px_rgba(245,158,11,0.1)]" />
                <div className="absolute inset-[0%] border border-[#f59e0b]/30 rounded-full pointer-events-none opacity-60 shadow-[inset_0_0_20px_rgba(245,158,11,0.05)]" />
              </div>
            </div>
          </div>
        </div>
